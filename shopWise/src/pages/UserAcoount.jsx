      ...
      <div className="py-4 border-bottom bg-white text-center">
        <div className="container">
          <h1
            ...
            style={{ color: "#0F2C59", fontSize: "32px" }}
          >
            Account
          </h1>
          ...
          <div className="col-12 col-lg-3">
            <div className="card p-4 border rounded-3 bg-white shadow-sm text-center">
              <div className="position-relative d-inline-block mx-auto mb-3">
                ...
                />
                <span
                  className="position-absolute bottom-0 end-0 bg-success rounded-circle d-flex align-items-center justify-content-center text-white border border-2 border-white"
              ...
              <div className="row g-0 border rounded-3 py-2 bg-light mb-4">
                <div className="col-4 border-end">
                  <strong className="text-dark d-block h5 mb-0 fw-bold">
                    3
                  </strong>
                  <small
              ...
              <div className="d-flex flex-column gap-1 text-start">
                {menuItems.map((item, idx) => (
                  <button
                    ...
                    style={{
                      fontSize: "14px",
                      backgroundColor:
                        activeTab === item.name ? "#E2F2EE" : "transparent",
                ...
                <button
                  className="btn w-100 py-2 px-3 fw-bold border-0 d-flex align-items-center gap-3 text-danger rounded-3"
                  style={{ fontSize: "14px" }}
                >
